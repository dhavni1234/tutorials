...
class TableViewController: UITableViewController {
    ...
    let TitleList = ["Burj Khalifa","Eiffel Tower","Empire State Building","Kingdom Tower","Taipei 101"]

    let DescriptionList = ["Dubai, UAE","Paris, France","New York, USA","Jeddah, Saudi Arabia","Taipei, Taiwan"]
