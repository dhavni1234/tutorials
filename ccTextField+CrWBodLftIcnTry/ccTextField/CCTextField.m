...
-(void)initialize {
    self.tintColor = [UIColor greenColor]; // code for curser color when we enter text to text field.
    [self initializeView];
...
-(void)drawRect:(CGRect)rect
{
    ...
    [leftContainerView setFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height+2)];
    [leftIconImageView setFrame:CGRectMake(self.frame.size.height/6, (self.frame.size.height/7), 21, 22)]; 
