...
- (void)viewDidLoad {
    ...
    self.imageView.layer.cornerRadius = self.imageView.frame.size.width /2; //for circular use width else height for rectangular.
...
//    [self.activityIndicator stopAnimating];
    // Checking imageView is nil or not.
