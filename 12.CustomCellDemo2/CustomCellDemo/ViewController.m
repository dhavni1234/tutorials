...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    SeconViewController *destVC = (SeconViewController*)segue.destinationViewController;
    
    destVC.labelText = [NSString stringWithFormat:@"Selecte row is %d", selectedRow];
    
    NSLog(@"Segue Perfomed");
}
